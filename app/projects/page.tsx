      ...
      <div ref={videoContainerRef}>
        <div className="fixed top-0 left-0 h-full w-full -z-10 ">
          ...
          <FullscreenVideo
            className="w-full h-full absolute top-0 left-0 opacity-0"
            paused
            src="WY/weaving_klpa5q"
            data-animation-id="video-weaving"
          />
        </div>
        ...
        <CoverPhoto fixed className="">
          ...
          <p className="text-brown text-center max-w-2xl mx-auto">
            Willka Yachay is helping Q’eros obtain the tools they need to
            sustain their culture and thrive in the modern world.
          </p>
        </CoverPhoto>
        ...
        >
          <p>
            Willka Yachay builds and sustains a culturally and ecologically
            based school system high in the Andes. We founded and built the
            first preschool, primary schools, high school and adult learning
            center in the Q’eros villages of Ch’allmachimpana and Qocha Moqo.
          </p>
          <p>
            Our schools teach the children to read and write in both their
            native Quechua and in Spanish, and prepare them to interact with the
            modern world while fostering their soulful and intelligent culture.
        ...
        >
          <p>
            ...
            life in Q’eros. Willka Yachay’s first successful energy project was
            a hydroelectric generator hand built and deployed by our high school
        ...
        >
          ...
          <p>
            Willka Yachay and our high school students built the first of
            several trout ponds that will supplement the local diet of potatoes
            and alpaca with fresh fish. Our students and their parents also
            built a greenhouse for raising guinea pigs and other small animals,
            as well as vegetables.
          </p>
          <p>
            We have partnered with individuals to install clean water systems
            for three Q’eros villages.
          </p>
        </ProjectsSection>
        ...
        >
          <p>
            ...
            “national living cultural patrimony” for the continuity of its
            ancient Andean traditions. Considered to be the{" "}
            <em>último ayllu inka,</em> or the last Inkan community of Peru, the
            Q’eros strive to preserve and promote their indigenous ethnic and
            cultural identity.
          </p>
          <p>
        ...
        >
          <p>
            ...
            perform at community events throughout the region and outside of
            Peru.
          </p>
        </ProjectsSection>

        <ProjectsSection
          title="Traditional & Western Medicine"
          slug="medicine"
          videoContainerRef={videoContainerRef}
        >
          <p>
          ...
          <p>
            ...
            transportation from Q’eros to city hospitals, rehabilitation care
            and patient/family social services.
          </p>
          <p>
        ...
        <ProjectsSection
          title="Weaving Cooperative"
          slug="weaving"
          videoContainerRef={videoContainerRef}
        >
          <p>
            Willka Yachay and Q’eros mothers and fathers have formed a
            cooperative to sell their traditional weavings at a just price
            locally and abroad. The celebration of this ancient and
            extraordinarily beautiful tradition at the heart of Q’eros culture
            is promoting its perpetuation by younger generations while enhancing
            community and family economic security.
          </p>
